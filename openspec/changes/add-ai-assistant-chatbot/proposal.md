...
- **SDD baseline:** aligns with `docs/ux-ui/design.md` (client UI/navigation) and `docs/trd/trd.md` (client architecture, feature flags). No module spec under `docs/specs/` changes its requirements.
