...
### [x] `KPM-T-4` — Parallel fan-out, per-source cache, statuses, telemetry, facet union
...
### [x] `KPM-T-8` — Hosts and server copy: banner by repository, generalized strings, grep gate
