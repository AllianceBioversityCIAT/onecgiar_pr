...
| `REH-AC-4` | REH-AC-3 state | The user types `1368` in the search | Only rows whose code or name contains `1368` remain, across both centers (both expanded); counter shows `1 / 61`. **BUT** clearing the search restores the 3-row slices and collapse states. |
