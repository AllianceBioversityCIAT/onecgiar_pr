...
- **Depends on:** owner approval of the v0.2 amendment · **Blocks:** `BIL-QAI-T-4b`, `BIL-QAI-T-5b`
- **Estimate:** S
- **Skills:** `api-design-principles`, `cognitive-doc-design`
...
- **Depends on:** `BIL-QAI-T-2`, owner approval of the v0.2 amendment · **Blocks:** `BIL-QAI-T-6`, `BIL-QAI-T-7`
- **Estimate:** S
- **Skills:** `nestjs-expert`
...
- **Depends on:** owner approval of the v0.2 amendment (client-only; independent of the whole server chain) · **Blocks:** `BIL-QAI-T-11`(b) fixture review
- **Estimate:** M
- **Skills:** `angular-developer`, `ui-ux-pro-max`
