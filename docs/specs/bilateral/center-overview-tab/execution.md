...
| **Actuals to date** | 3 tasks · ~2,975 LOC · 5 review rounds (T-2, T-3: full + delta each) — **over the 1,700 budget; > 50 % tripwire (2,550) crossed, see T-3 entry** |
| **Active rework loop** | `COV-T-7` review (attempt 1 + amendment) |
