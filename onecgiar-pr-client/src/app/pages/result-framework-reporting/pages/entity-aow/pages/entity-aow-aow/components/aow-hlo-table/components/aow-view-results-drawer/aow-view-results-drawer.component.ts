...
export class AowViewResultsDrawerComponent {
  entityAowService = inject(EntityAowService);

  columns = signal<ColumnOrder[]>([
    { title: 'Code', attr: 'code', width: '10%' },
    { title: 'Title', attr: 'title' },
    { title: 'Status', attr: 'status', width: '20%' }
  ]);

  dummyData = signal<any[]>([
    { code: '11231', title: 'Result 1', status: 'Submitted', pdfDocument: 'https://www.google.com', actions: 'View' },
    { code: '2', title: 'Result 2', status: 'Quality Assessed', pdfDocument: 'https://www.google.com', actions: 'View' },
    { code: '3', title: 'Result 3', status: 'Editing', pdfDocument: 'https://www.google.com', actions: 'View' }
  ]);
