...
// instead of being force-fitted into one beforeEach.
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        // staging added the review deep-link, so the component now injects the router pair.
        // These tests only exercise filtering/grouping, hence the inert stubs.
...
describe('ResultsReviewTableComponent — review deep link', () => {
  let component: ResultsReviewTableComponent;
  let fixture: ComponentFixture<ResultsReviewTableComponent>;
