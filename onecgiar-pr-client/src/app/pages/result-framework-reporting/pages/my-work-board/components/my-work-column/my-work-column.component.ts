// @akili-spec changes/my-work-board (MWB-T-4, MWB-R-2, R-11, design.md §6.2, §6.3, DD-7, DD-8)
...
/** `status_id` → visual dot + count-pill classes (design.md §6.3). Approved deliberately does
 *  NOT reuse `STATUS_META[2]`'s blue "QAed" pair — `MWB-DD-7`: the intermediate QA state would
 *  read more "done" than the final Approved one, so Approved gets the green approved tokens.
