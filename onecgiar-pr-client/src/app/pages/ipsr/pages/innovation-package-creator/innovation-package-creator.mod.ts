...
@NgModule({
  ...
  imports: [CommonModule, InnovationPackageCreatorRoutingModule, SectionHeaderModule, ResultsInnovationOutputListModule, IpsrGeoscopeCreatorModule, FeedbackValidationDirectiveModule, DialogModule, GeoscopeManagementModule],
