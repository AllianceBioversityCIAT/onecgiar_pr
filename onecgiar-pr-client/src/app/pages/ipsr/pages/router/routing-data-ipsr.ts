...
export const IPSRDetailRouting: PrRoute[] = [
  { prName: 'General information', path: 'general-information', loadChildren: () => import('../innovation-package-detail/pages/ipsr-general-information/ipsr-general-information.module').then(m => m.IpsrGeneralInformationModule) },
