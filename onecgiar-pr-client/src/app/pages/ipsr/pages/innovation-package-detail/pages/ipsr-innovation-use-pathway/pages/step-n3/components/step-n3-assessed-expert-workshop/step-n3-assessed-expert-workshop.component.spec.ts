...
describe('StepN3AssessedExpertWorkshopComponent', () => {
  ...
  it('should return expected string on goToStep', () => {
    ...
    expect(result).toBe(`<li>In case you want to add one more complementary innovation/enabler/solution <a class='open_route' href='/ipsr/detail/123/ipsr-innovation-use-pathway/step-2/complementary-innovation' target='_blank'> Go to step 2</a>.</li>
