 ...
 * delayed write notified nothing, so the "Add Partner" dialog stayed empty after being closed and reopened,
...
describe('StepN4AddPartnerComponent (zoneless change detection)', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      declarations: [StepN4AddPartnerComponent, StubPrDialogComponent],
  ...
  it('repaints the add-partner form after the dialog is closed and cleanObject() remounts it', async () => {
