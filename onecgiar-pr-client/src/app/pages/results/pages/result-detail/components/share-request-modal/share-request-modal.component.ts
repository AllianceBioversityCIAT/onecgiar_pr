...
export class ShareRequestModalComponent implements OnInit {
  ...
  validateAcceptOrReject() {
    const resultWithoutTRI =
      this.shareRequestModalSE.shareRequestBody.result_toc_results.find(
        result => !result.toc_result_id
      );
  ...
  onRequest() {
    ...
    this.api.resultsSE
      .POST_createRequest(this.shareRequestModalSE.shareRequestBody)
      .subscribe({
        next: resp => {
        ...
        this.shareRequestModalSE.shareRequestBody.result_toc_results = [
          {
            ...
            official_code,
            planned_result:
              this.shareRequestModalSE.shareRequestBody.planned_result,
            results_id: null,
            short_name,
            toc_result_id: null,
