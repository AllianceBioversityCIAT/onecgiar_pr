...
@NgModule({
  ...
  imports: [CommonModule, RdGeneralInformationRoutingModule, InstitutionsPipesModule, FeedbackValidationDirectiveModule, DialogModule, TableModule, PdfIconModule]
})
