...
// `UCA-T-6` (routing fix) — `canDeactivate` lives on THIS inner route, not on the outer
...
const routes: Routes = [{ path: '', component: RdGeneralInformationComponent, canDeactivate: [UnsavedChangesGuard] }];
