...
import { TocInitiativeAaoModule } from './components/shared/toc-initiative-aao/toc-initiative-aao.module';

@NgModule({
  declarations: [RdTheoryOfChangeComponent, TocImpactSectionComponent, TocActionAreaOutcomeSectionComponent, TocInitiativeOutcomeSectionComponent, TocInitiativeOutputSectionComponent, FilterTargetsPipe, FilterIndicatorsPipe],
  imports: [CommonModule, RdTheoryOfChangeRoutingModule, CustomFieldsModule, RadioButtonModule, TocInitiativeOutModule, TocInitiativeAaoModule]
})
