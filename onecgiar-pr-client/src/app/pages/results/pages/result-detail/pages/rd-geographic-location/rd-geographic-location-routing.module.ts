...
// `UCA-T-7` (routing fix) — `canDeactivate` lives on THIS inner route, not on the outer
...
const routes: Routes = [{ path: '', component: RdGeographicLocationComponent, canDeactivate: [UnsavedChangesGuard] }];
