...
export class RdTheoryOfChangeComponent implements OnInit {
  ...
  onSaveSection() {
    ...
    this.theoryOfChangeBody.result_toc_result.result_toc_results = this.theoryOfChangeBody?.result_toc_result?.result_toc_results.filter(result => result.toc_result_id !== null);
