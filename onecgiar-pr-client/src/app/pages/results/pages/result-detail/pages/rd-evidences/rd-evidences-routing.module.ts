...
// `UCA-T-8` (routing fix) — `canDeactivate` lives on THIS inner route, not on the outer
...
const routes: Routes = [{ path: '', component: RdEvidencesComponent, canDeactivate: [UnsavedChangesGuard] }];
