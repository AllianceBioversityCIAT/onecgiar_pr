...
@NgModule({
  ...
  imports: [CommonModule, ResultDetailRoutingModule, PartnersRequestModule, BreadcrumbModule, ButtonModule, SubmissionModalModule, UnsubmitModalModule, PdfActionsModule, ToastModule, PhaseSwitcherModule]
})
