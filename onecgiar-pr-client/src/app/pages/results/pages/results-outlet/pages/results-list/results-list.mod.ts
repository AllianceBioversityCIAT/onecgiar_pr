...
@NgModule({
  ...
  imports: [CommonModule, ResultsListRoutingModule, CustomSpinnerModule, TableModule, ButtonModule, MenuModule, ResultsToUpdateModalModule, ChangePhaseModalModule, RouterModule, FormsModule, ResultsListFilterPipeModule, PdfIconModule, TooltipModule]
})
