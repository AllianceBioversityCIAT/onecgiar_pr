...
export const routingApp: PrRoute[] = [
  ...
  { prName: 'Innovation Packages', underConstruction: true, onlytest: true, canActivate: [CheckLoginGuard], path: 'ipsr', loadChildren: () => import('../../pages/ipsr/ipsr.module').then(m => m.IpsrModule) },
