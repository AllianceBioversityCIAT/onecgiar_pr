...
export const routingApp: PrRoute[] = [
  ...
  { prName: 'Type 1 report elements', prHide: true, underConstruction: false, onlytest: false, canActivate: [false], path: 'type-one-report', loadChildren: () => import('../../pages/type-one-report/type-one-report.module').then(m => m.TypeOneReportModule) },
