...
export const routingApp: PrRoute[] = [
  ...
  { prName: 'Type 1 report elements', underConstruction: false, onlytest: true, canActivate: [CheckLoginGuard, CheckAdminGuard], path: 'type-one-report', loadChildren: () => import('../../pages/type-one-report/type-one-report.module').then(m => m.TypeOneReportModule) },
