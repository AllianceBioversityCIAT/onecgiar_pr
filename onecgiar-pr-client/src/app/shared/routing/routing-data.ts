...
export const routingApp: PrRoute[] = [
  ...
  { prName: 'Quality Assurance', canActivate: [CheckLoginGuard], path: 'quality-assurance', loadChildren: () => import('../../pages/quality-assurance/quality-assurance.module').then(m => m.QualityAssuranceModule) },
