export const internationalizationData = {
  ...
  reportNewResult: {
    greeting: (name: string) => `Hello ${name}, you can report for INIT-17 and INIT-28. If you would like to report for another Initiative, please contact Project Coordination Unit.`,
    alerts: {
