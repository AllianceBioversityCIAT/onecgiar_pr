...
describe('ReportingNavSidebarComponent', () => {
  ...
  describe('EXTRAS holds Release notes only (P2-3682)', () => {
    ...
    it('renders exactly one Extras entry, and it is Release notes', () => {
      const extras = readExtrasMarkup();
      expect(extras.split('<li hlmSidebarMenuItem>').length - 1).toBe(1);
