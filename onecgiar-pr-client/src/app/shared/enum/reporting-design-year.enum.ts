...
export const ReportingDesignYear = {
   ...
   * the "Evidence of user need/user demand" block (P2-3641) and the "How have the end
   * users/stakeholders been involved in defining assumptions and purposes…?" question with its
   * "Why?" box (question 136, P2-3642) stop being shown. Results in the 2025 phase (and earlier)
   * keep all four, with their stored answers — the epic's governing rule is that previous phases
   * must render exactly as they did.
   *
   * P2-3641 and P2-3642 reuse this threshold instead of adding their own: both are the same rule
   * reaching one more block of the same form (P2-3641 declares itself a "Complement to: P2-3263",
   * and the PO answered P2-3642 with "Option A. Apply 2026 onward" on 10 Sep 2026), which is
   * exactly what decision D2 of that change asked for — one threshold per rule, not per ticket.
   * A future divergence between the blocks is the only reason to split it.
   *
