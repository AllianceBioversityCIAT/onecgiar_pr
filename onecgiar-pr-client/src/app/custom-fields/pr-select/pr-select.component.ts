import { Component, forwardRef, Input, Output, EventEmitter, ElementRef, HostListener, OnChanges, SimpleChanges } from '@angular/core';
...
export class PrSelectComponent implements ControlValueAccessor, OnChanges {
