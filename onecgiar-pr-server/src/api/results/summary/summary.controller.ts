...
export class SummaryController {
  ...
  async saveInnovationUse(
    ...
    const { message, response, status } =
      await this.summaryService.saveInnovationUse(
        innovationUseDto,
        resultId,
        token,
      );
  ...
  async saveCapacityDevelopents(
    ...
    const { message, response, status } =
      await this.summaryService.saveCapacityDevelopents(
        capdevDto,
        resultId,
        token,
      );
  ...
  async getCapacityDevelopents(@Param('resultId') resultId: number) {
    const { message, response, status } =
  ...
  async saveInnovationDev(
    ...
    const { message, response, status } =
      await this.summaryService.saveInnovationDev(
  ...
  async getInnovationDev(@Param('resultId') resultId: number) {
    const { message, response, status } =
  ...
  async savePolicyChanges(
    ...
    const { message, response, status } =
      await this.summaryService.savePolicyChanges(
        policyChangesDto,
        resultId,
        token,
      );
  ...
  async getPolicyChanges(@Param('resultId') resultId: number) {
    const { message, response, status } =
