...
export class ResultsByInititiativesController {
  ...
  @Post()
  create(@Body() createResultsByInititiativeDto: CreateResultsByInititiativeDto) {
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateResultsByInititiativeDto: UpdateResultsByInititiativeDto) {
    return this.resultsByInititiativesService.update(+id, updateResultsByInititiativeDto);
  }
