...
import { InititiativesModule } from './inititiatives/inititiatives.module';
...
@Module({
  ...
  imports: [RouterModule.register(resultsRoutes), ResultLevelsModule, ResultTypesModule, GenderTagLevelsModule, UsersModule, VersionsModule, InititiativesModule, InstitutionRolesModule, ResultsByInititiativesModule, ResultsByInstitutionsModule, ResultsByInstitutionTypesModule],
