...
export class LegacyIndicatorsLocationsController {
  ...
  create(
    @Body()
    createLegacyIndicatorsLocationDto: CreateLegacyIndicatorsLocationDto,
  ) {
    return this.legacyIndicatorsLocationsService.create(
  ...
  update(
    ...
    return this.legacyIndicatorsLocationsService.update(
      +id,
      updateLegacyIndicatorsLocationDto,
    );
  }
