...
export class ResultsPackageByInitiativesController {
  ...
  create(
    ...
    return this.resultsPackageByInitiativesService.create(
      createResultsPackageByInitiativeDto,
    );
  }
  ...
  update(
    ...
    return this.resultsPackageByInitiativesService.update(
      +id,
      updateResultsPackageByInitiativeDto,
    );
  }
