...
export class ResultInnovationPackageCountriesController {
  constructor(private readonly resultInnovationPackageCountriesService: ResultInnovationPackageCountriesService) {}

  @Post()
  create(@Body() createResultInnovationPackageCountryDto: CreateResultInnovationPackageCountryDto) {
    return this.resultInnovationPackageCountriesService.create(createResultInnovationPackageCountryDto);
  }
  ...
  @Patch(':id')
  update(@Param('id') id: string, @Body() updateResultInnovationPackageCountryDto: UpdateResultInnovationPackageCountryDto) {
    return this.resultInnovationPackageCountriesService.update(+id, updateResultInnovationPackageCountryDto);
  }
