...
describe('InnovationPathwayStepFourService', () => {
  ...
  const mockEvidenceSaveResponse = {
    ...
    policy_change_related: false,
    capacity_sharing_related: false,
    other_output_related: false,
    other_outcome_related: false,
    knowledge_product_metadata_related: false,
    result_id: null,
    evidence_type_id: 2,
    is_active: 1,
    created_by: null,
  ...
  describe('saveMain', () => {
    it('should save step four data successfully', async () => {
      ...
      const mockResult = {
        ...
        obj_extra_geographic_scope: null,
        ...
        obj_gender_impact_area: null,
        obj_climate_change_tag_level: null,
        obj_climate_impact_area: null,
        obj_nutrition_tag_level: null,
        obj_nutrition_impact_area: null,
        obj_environmental_biodiversity_tag_level: null,
        obj_environmental_biodiversity_impact_area: null,
        obj_poverty_tag_level_id: null,
        obj_poverty_impact_area: null,
        obj_version: null,
        obj_created: null,
