...
export class NonPooledPackageProjectsController {
  ...
  @Post()
  create(
    @Body() createNonPooledPackageProjectDto: CreateNonPooledPackageProjectDto,
  ) {
    return this.nonPooledPackageProjectsService.create(
  ...
  update(
    @Param('id') id: string,
    @Body() updateNonPooledPackageProjectDto: UpdateNonPooledPackageProjectDto,
  ) {
    return this.nonPooledPackageProjectsService.update(
      +id,
      updateNonPooledPackageProjectDto,
    );
  }
