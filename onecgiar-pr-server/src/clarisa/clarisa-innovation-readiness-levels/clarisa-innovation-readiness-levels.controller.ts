...
export class ClarisaInnovationReadinessLevelsController {
  ...
  create(
    ...
    return this.clarisaInnovationReadinessLevelsService.create(
  ...
  update(
    ...
    return this.clarisaInnovationReadinessLevelsService.update(
      +id,
      updateClarisaInnovationReadinessLevelDto,
    );
  }
