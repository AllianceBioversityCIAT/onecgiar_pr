...
export class ClarisaSecondOrderAdministrativeDivisionController {
  constructor(private readonly clarisaSecondOrderAdministrativeDivisionService: ClarisaSecondOrderAdministrativeDivisionService) { }
  ...
  async findAll(
    ...
    const { response, message, status } =
      await this.clarisaSecondOrderAdministrativeDivisionService.getIsoAlpha2AdminCode(isoAlpha2, adminCode1);
