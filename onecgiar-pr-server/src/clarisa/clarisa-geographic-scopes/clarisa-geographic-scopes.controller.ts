...
export class ClarisaGeographicScopesController {
  ...
  @Post()
  create(
    @Body() createClarisaGeographicScopeDto: CreateClarisaGeographicScopeDto,
  ) {
    return this.clarisaGeographicScopesService.create(
      createClarisaGeographicScopeDto,
    );
  }
  ...
  update(
    @Param('id') id: string,
    @Body() updateClarisaGeographicScopeDto: UpdateClarisaGeographicScopeDto,
  ) {
    return this.clarisaGeographicScopesService.update(
      +id,
      updateClarisaGeographicScopeDto,
    );
  }
