...
export class ClarisaInnovationTypeController {
  ...
  @Post()
  create(
    @Body() createClarisaInnovationTypeDto: CreateClarisaInnovationTypeDto,
  ) {
    return this.clarisaInnovationTypeService.create(
  ...
  update(
    @Param('id') id: string,
    @Body() updateClarisaInnovationTypeDto: UpdateClarisaInnovationTypeDto,
  ) {
    return this.clarisaInnovationTypeService.update(
      +id,
      updateClarisaInnovationTypeDto,
    );
  }
