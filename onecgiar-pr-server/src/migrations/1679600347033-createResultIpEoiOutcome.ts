...
export class createResultIpEoiOutcome1679600347033 implements MigrationInterface {
    name = 'createResultIpEoiOutcome1679600347033'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query('DROP TABLE IF EXISTS result_ip_eoi_outcomes;');
