...
export class resultTypeRefactorv21664313260937 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`result_level\` CHANGE \`id\` \`id\` bigint NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`result_level\` ADD \`id\` int NOT NULL PRIMARY KEY AUTO_INCREMENT`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`result_level\` DROP COLUMN \`id\``);
        await queryRunner.query(`ALTER TABLE \`result_level\` ADD \`id\` bigint NOT NULL AUTO_INCREMENT`);
        await queryRunner.query(`ALTER TABLE \`result_level\` ADD PRIMARY KEY (\`id\`)`);
        await queryRunner.query(`ALTER TABLE \`result_level\` CHANGE \`id\` \`id\` bigint NOT NULL AUTO_INCREMENT`);
    }
