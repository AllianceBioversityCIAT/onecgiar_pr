...
export class auditableColumnsUsers1663362784548 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`role\` ADD \`update_by\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`roles_user_by_aplication\` ADD \`update_by\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`users\` ADD \`update_by\` int NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`complementary_data_users\` ADD \`update_by\` int NOT NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE \`complementary_data_users\` DROP COLUMN \`update_by\``);
        ...
        await queryRunner.query(`ALTER TABLE \`roles_user_by_aplication\` DROP COLUMN \`update_by\``);
