...
export class resultsdatamodel1663773959336 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE \`gender_tag_level\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`title\` varchar(45) NOT NULL, \`description\` varchar(500) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`result_level\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(45) NOT NULL, \`description\` varchar(500) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`result_type\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(100) NOT NULL, \`description\` varchar(500) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`user\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`first_name\` varchar(200) NOT NULL, \`last_name\` varchar(200) NOT NULL, \`email\` varchar(500) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`version\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`version_name\` varchar(45) NOT NULL, \`start_date\` varchar(45) NOT NULL, \`end_date\` varchar(45) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`result\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`title\` varchar(45) NOT NULL, \`description\` text NOT NULL, \`is_active\` tinyint NOT NULL, \`created_date\` timestamp NOT NULL, \`last_updated_date\` timestamp NOT NULL, \`result_level_id\` bigint NULL, \`result_type_id\` bigint NULL, \`gender_tag_level_id\` bigint NULL, \`version_id\` bigint NOT NULL, \`created_by\` bigint NOT NULL, \`last_updated_by\` bigint NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`inititiative\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`official_code\` varchar(45) NOT NULL, \`name\` varchar(500) NOT NULL, \`short_name\` varchar(100) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`institution_role\` (\`id\` bigint NOT NULL AUTO_INCREMENT, \`name\` varchar(50) NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`results_by_inititiative\` (\`result_id\` bigint NOT NULL, \`inititiative_id\` bigint NOT NULL, \`role\` bigint NOT NULL, \`is_active\` tinyint NOT NULL, \`created_date\` timestamp NOT NULL, \`last_updated_date\` timestamp NOT NULL, \`resultIdId\` bigint NULL, \`inititiativeIdId\` bigint NULL, \`version_id\` bigint NOT NULL, \`created_by\` bigint NOT NULL, \`last_updated_by\` bigint NULL, PRIMARY KEY (\`result_id\`, \`inititiative_id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`results_by_institution_type\` (\`results_id\` bigint NOT NULL AUTO_INCREMENT, \`is_active\` tinyint NOT NULL, \`creation_date\` timestamp NOT NULL, \`last_updated_date\` timestamp NOT NULL, \`institution_roles_id\` bigint NOT NULL, \`version_id\` bigint NOT NULL, \`created_by\` bigint NOT NULL, \`last_updated_by\` bigint NULL, PRIMARY KEY (\`results_id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
      `CREATE TABLE \`results_by_institution\` (\`results_id\` bigint NOT NULL AUTO_INCREMENT, \`institutions_id\` int NOT NULL, \`institution_roles_id\` bigint NOT NULL, \`is_active\` tinyint NOT NULL, \`created_date\` timestamp NOT NULL, \`last_updated_date\` timestamp NOT NULL, \`version_id\` bigint NOT NULL, \`created_by\` bigint NOT NULL, \`last_updated_by\` bigint NULL, PRIMARY KEY (\`results_id\`)) ENGINE=InnoDB`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`result\` ADD CONSTRAINT \`FK_87067d6e5348ba4b09bd3c4cb64\` FOREIGN KEY (\`result_type_id\`) REFERENCES \`result_type\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`result\` ADD CONSTRAINT \`FK_99e440b135663e707b3f8386212\` FOREIGN KEY (\`gender_tag_level_id\`) REFERENCES \`gender_tag_level\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE \`result\` ADD CONSTRAINT \`FK_dd923902fe9bd17c971a4bd987e\` FOREIGN KEY (\`version_id\`) REFERENCES \`version\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`results_by_inititiative\` ADD CONSTRAINT \`FK_a0c6f82ad47568f33cd124a3fab\` FOREIGN KEY (\`resultIdId\`) REFERENCES \`result\`(\`id\`) ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE \`results_by_inititiative\` DROP FOREIGN KEY \`FK_a0c6f82ad47568f33cd124a3fab\``,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE \`result\` DROP FOREIGN KEY \`FK_dd923902fe9bd17c971a4bd987e\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`result\` DROP FOREIGN KEY \`FK_99e440b135663e707b3f8386212\``,
    );
    await queryRunner.query(
      `ALTER TABLE \`result\` DROP FOREIGN KEY \`FK_87067d6e5348ba4b09bd3c4cb64\``,
    );
    await queryRunner.query(
